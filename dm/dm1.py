...
def puissance2(n):
    ...
    for i in range(n):
        L.append(2**i)
    return L
#Ici mon programme renvoie les puissances de 2 jusqu'à n-1 pour être aligné avec l'exemple de l'énoncé. Pour aller réellement jusqu'à 2**n il faudrait coder "for i in range(n+1)"
